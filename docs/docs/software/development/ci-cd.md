...
El pipeline de CI/CD automatiza:

1. **Build** - Compilación del firmware y web app
2. **Test** - Ejecución de tests unitarios
3. **Lint** - Verificación de estilo de código
4. **Release** - Generación de binarios
