---
id: display-ui
title: Interfaz de Display
sidebar_label: Display UI
sidebar_position: 5
description: Implementación de la interfaz de usuario en display para IncuNest
...
| Tipo | Resolución | Interface | Librería |
|------|------------|-----------|----------|
| LCD 20x4 | 20 caracteres x 4 líneas | I2C (PCF8574) | LiquidCrystal_I2C |
| TFT 3.5" | 480x320 píxeles | SPI | TFT_eSPI |
...
- [Conectividad WiFi](./wifi-connectivity)
