...
The IncuNest web app provides a modern user interface to monitor and control the incubator from any browser.
...
The web app is compiled and packaged in SPIFFS:
