...
IncuNest supports two types of screen:

| Type | Resolution | Connection | Usage |
|------|------------|----------|-----|
| LCD 20x4 | 20 characters x 4 lines | I2C | Basic/Economy |
| TFT 3.5" | 480x320 pixels | SPI | Advanced/Graphic |
...
|-----|-------|------|---------|
| LED1 | Red | GPIO12 | Alarm/Error |
| LED2 | Green | GPIO13 | OK/Operating |
| LED3 | Blue | GPIO14 | Info/WiFi |
...
|-------|------|--------|
| UP | GPIO33 | Upload value/Browse |
| DOWN | GPIO34 | Lower value/Browse |
| SELECT | GPIO35 | Select/Confirm |
| BACK | GPIO36 | Return/Cancel |
