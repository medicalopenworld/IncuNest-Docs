...
| Sensor | Tipo | Interface | Medición |
|--------|------|-----------|----------|
...
- Direcciones: 0x44 (ADDR=GND) o 0x45 (ADDR=VDD)
...
1. **Condensación:** El sensor puede dar lecturas erróneas si hay condensación. Usar el calentador interno brevemente puede ayudar.

2. **Tiempo de respuesta:** ~8 segundos para cambios de temperatura, ~8 segundos para humedad.

3. **Filtrado:** Se recomienda aplicar filtro de media móvil para reducir ruido.
...
Gestor unificado de todos los sensores:
...
### Selección del coeficiente alpha

| Alpha | Comportamiento | Uso |
|-------|----------------|-----|
| 0.1 | Muy suave, lento | Humedad |
| 0.2 | Suave | Temperatura general |
| 0.5 | Moderado | Respuesta rápida |
| 0.9 | Casi sin filtro | Debugging |
