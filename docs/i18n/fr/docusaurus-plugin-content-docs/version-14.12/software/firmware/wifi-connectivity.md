...
El ESP32 soporta tres modos de WiFi:

| Modo | Descripción | Uso |
|------|-------------|-----|
| Station (STA) | Conecta a red existente | Operación normal |
| Access Point (AP) | Crea red propia | Configuración inicial |
| Dual (STA+AP) | Ambos simultáneos | Fallback |
