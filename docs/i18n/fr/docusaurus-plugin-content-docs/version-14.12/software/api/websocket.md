...
La API WebSocket de IncuNest proporciona comunicación bidireccional en tiempo real, ideal para actualizaciones continuas de sensores y control interactivo.
...
Todos los mensajes utilizan JSON con la estructura:
...
Se envía automáticamente cada segundo a clientes suscritos.
...
**Canales disponibles:**
- `sensors` - Actualizaciones de sensores
- `alarms` - Eventos de alarma
...
## Implementación Completa (JavaScript)
...
| 1006 | Cierre anormal |
| 4000 | Error de autenticación |
| 4001 | Comando inválido |
| 4002 | Parámetros inválidos |
