...
sidebar_position: 4
description: Técnicas e ferramentas de debugging para IncuNest
...
A forma mais básica e útil de debugging.
...
- ESP-Prog ou adaptador JTAG compatível
- Cabos de ligação
...
1. Ligar ESP-Prog ao ESP32
2. No VS Code, ir ao Run & Debug (F5)
3. Seleccionar o "PIO Debug"
...
Quando o ESP32 crashea, mostra um stack trace. Para descodificar:
...
Instalar a extensão do navegador Vue.js devtools.

## Network Tab

Para debugging de chamadas API:
...
Assegurar que o source maps esteja habilitado:
...
**Causa:** Loop bloqueador sem eield.
...
**Solução:**
- Reduzir o buffers
- Utilizar PSRAM se estiver disponível
