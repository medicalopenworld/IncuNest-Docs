...
sidebar_position: 3
description: Guia de testes para o desenvolvimento de IncuNest
...
Unity é um framework leve de testeing para C/C++ ideal para embedded.
...
### Exemplo: Teste do Controlador PID
...
## Exemplo: Teste do Alarm Manager
...
### Exemplo: Teste da Componente Vue
...
Ver [CI/CD] (./ci-cd) para configuração de testes automatizados.
