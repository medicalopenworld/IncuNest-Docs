...
sidebar_label: CI/CD
sidebar_position: 5
description: Configuração da Integração e Despliegue Continuo para IncuNest
...
1. **Build** - Compilação do firmware e web app
2. **Test** - Execução de testes unitários
3. **Lint** - Verificação de estilo de código
4. **Release** - Geração de binários
