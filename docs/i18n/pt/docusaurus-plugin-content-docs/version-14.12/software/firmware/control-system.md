...
sidebar_label: Sistema de Controle
sidebar_position: 3
description: Documentação do Sistema de Controlo PID do IncuNest
keywords: [PID, control, temperatura, regulación]
---

# Sistema de Controle

## Teoria do Controlo PID

O sistema de controle do IncuNest utiliza um controlador PID (Proporcional-Integral-Derivativo) para regular a temperatura de maneira precisa e estável.

## Equação PID

O resultado do controlador é calculado como:
...
Onde:
- u(t) = Saída do controlador (potência do aquecedor)
- e(t) = Erro = Setpoint - Temperatura actual
...
O controle de umidade usa uma abordagem mais simples (ON/OFF com histéresis):
...
- [Integração dos Sensores] (./sensors-integration)