...
sidebar_label: WiFi
sidebar_position: 6
description: Suporte para conectividade WiFi em IncuNest
...
O ESP32 suporta três modos de WiFi:

| Modo | Descrição | Uso |
|------|-------------|-----|
| Station (STA) | Conecta à rede existente | Operação normal |
| Access Point (AP) | Cria rede própria | Configuração inicial |
| Dual (STA+AP) | Ambos simultâneos | Fallback |
...
## Monitoramento de Qualidade WiFi
