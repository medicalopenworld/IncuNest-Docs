...
sidebar_position: 1
description: Documentação da aplicação Web do IncuNest
...
A aplicação Web do IncuNest oferece uma interface de usuário moderna para monitorar e controlar a incubadora de qualquer navegador.
...
- Temperatura actual e setpoint
- Humedad actual e setpoint
- Potência do calefator
- Estado do sistema
- Alarmes Ativas
...
O app Web é compilado e embalado no SPIFFS:
