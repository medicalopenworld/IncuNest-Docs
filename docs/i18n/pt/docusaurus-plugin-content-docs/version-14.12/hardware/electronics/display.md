...
sidebar_position: 4
description: Ecrã e LEDs de IncuNest
...
IncuNest suporta dois tipos de ecrã:

| Tipo | Resolução | Conexão | Uso |
|------|------------|---------|------|-----|-----|-----|
| LCD 20x4 | 20 caracteres x 4 linhas | I2C | Básico/Econômico |
| TFT 3.5" | 480x320 pixels | SPI | Avançado/Gráfico |
...
| LED | Cor | GPIO | Função |
|-----|-------|------|----------|
| LED1 | Vermelho | GPIO12 | Alarma/Error |
...
| DOWN | GPIO34 | Baixar valor/Navegar |
| SELECT | GPIO35 | Seleccionar/Confirmar |
| BACK | GPIO36 | Voltar/Cancelar |
